...
import com.harry.base.security.core.exception.AppSecurityException;
import com.harry.base.security.core.util.AuthUtil;
 ...
 */
@Component
@ConditionalOnBean(type = "com.harry.base.security.web.config.WebSecurityBeanConfig")
