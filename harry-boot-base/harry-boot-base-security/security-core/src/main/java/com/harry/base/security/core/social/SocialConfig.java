...
public class SocialConfig extends SocialConfigurerAdapter {
  ...
  public UsersConnectionRepository getUsersConnectionRepository(
    ...
    jdbcUsersConnectionRepository
        .setTablePrefix(SecurityConstants.DEFAULT_SOCIAL_USER_CONNECTION_PREFIX);
  ...
  /**
   * <br>提供查询社交账户信息服务，绑定/解绑等服务<br/>
   * <br>为什么在ConnectController中已经注明了@Controller，而在此处还需要显示的声明一个@Bean对象<br/>
   * 我的理解是因为security-core 默认只扫描：@ComponentScan({"harry.base.security"})
   *
