package com.harry.base.security.core.constant;
...
public class SecurityConstants {
  ...
  /**
   * 从ServletWebRequest中读取的参数名称
   */
  public static final String SERVLET_REQUEST_PARAM_MOBILE = "mobile";
  public static final String SERVLET_REQUEST_PARAM_WIDTH = "width";
  public static final String SERVLET_REQUEST_PARAM_HEIGHT = "height";

  /**
   * swagger2需要放行的资源
   */
  public static final String SWAGGER_UI = "/swagger-ui.html";
  public static final String SWAGGER_API = "/v2/**";
